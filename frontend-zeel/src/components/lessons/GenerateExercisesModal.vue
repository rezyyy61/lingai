      ...
      >
        ...
        <div class="px-6 pt-6 pb-2 flex items-center justify-between">
            <div class="flex items-center gap-3">
               <div class="h-10 w-10 rounded-full bg-emerald-100 flex items-center justify-center text-emerald-600 dark:bg-emerald-900/20 dark:text-emerald-400">
                  <Icon icon="solar:clipboard-list-bold-duotone" class="h-6 w-6" />
               </div>
               <div>
                  <h2 class="text-lg font-display font-bold text-[var(--app-text)]">Generate Exercises</h2>
                  <p class="text-xs text-[var(--app-text-muted)]">Create practice questions and quizzes</p>
               </div>
            </div>
        ...
        <form @submit.prevent="handleSubmit" class="p-6 space-y-6">
              ...
              <!-- Textarea -->
               <div class="space-y-1.5">
                  ...
                  <textarea
                    ...
                    rows="4"
                    placeholder="E.g. Create multiple choice questions about the main characters..."
           ...
           <div class="flex flex-col gap-2 rounded-2xl bg-[var(--app-panel-muted)] p-4 border border-[var(--app-border)]">
              <label class="flex items-center justify-between cursor-pointer group">
                 <span class="text-sm font-medium text-[var(--app-text)]">Replace existing exercises</span>
           ...
           >
              ...
              <div v-else class="flex items-center gap-2">
                 <Icon icon="solar:play-circle-bold-duotone" class="h-5 w-5" />
