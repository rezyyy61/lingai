    ...
    >
      ...
      >
        <div class="flex items-center justify-between">
          <div>
            <h2 class="text-lg font-semibold">Generate shadowing sentences</h2>
            <p class="text-sm text-[var(--app-text-muted)] dark:text-[var(--app-text-muted)]">Create fresh sentences for this lesson.</p>
          </div>
          <button
        ...
        <form class="mt-6 space-y-5" @submit.prevent="handleSubmit">
          <label class="block text-sm text-[var(--app-text)] dark:text-[var(--app-text)]">
            ...
            <textarea
              ...
              placeholder="Describe the tone, topic, or style you need."
            ></textarea>
          </label>
          ...
          <div class="flex flex-col gap-3 pt-2 sm:flex-row sm:justify-end">
            ...
            >
              {{ isSubmitting ? 'Generating…' : 'Generate shadowing sentences' }}
            </button>
          </div>
        </form>
      </div>
